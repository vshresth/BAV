...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.beneficiaryAccountPreValidationProviderAPI.base-path:/v1}") String basePath) {
